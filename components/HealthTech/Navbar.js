...
import logo from "/public/images/saas/bold-logo.png";
    ...
    <>
      <header id="header" className="headroom health-tech-navbar">
        <div className="startp-nav">
          <div className="container mw-1720">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          onClick={toggleNavbar}
                          className={`nav-link ${
                            currentPath == "/saas/" && "active"
                          }`}
                        >
                          SaaS <span className="new">New</span>
                        </Link>
                      </li>
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          onClick={toggleNavbar}
                          className={`nav-link ${
                            currentPath == "/fintech/" && "active"
                          }`}
                        >
                          FinTech <span className="new">New</span>
                        </Link>
                      </li>
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          onClick={toggleNavbar}
                          className={`nav-link ${
                            currentPath == "/health-tech/" && "active"
                          }`}
                        >
                          HealthTech <span className="new">New</span>
                        </Link>
                      </li> 
                    </ul>
                  </li>
